    ...
    public class CarDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Review>().HasData(
                ...
                new Review { ReviewId = 2, Rating = 1, Comments = "Would not buy again, not 10/10", PhotoUrl = "https://s1.1zoom.me/b5154/579/Toyota_Supra_mk5_GR_A90_Gazoo_Racing_mkV_2.0L_584944_2560x1440.jpg", DatePosted = new DateOnly(2024, 4, 23), UserId = 2, CarId = 2 }, //input validation needed for adding new photo review links
